        ...
        <table id="mi-tabla" class="table">
            <thead class="table-dark">
                <tr>
                    ...
                    <th class="text-uppercase text-xxs mb-0 text-center" scope="col"><h6>desc.</h6></th>
                    <th class="text-uppercase text-xxs mb-0 text-center" scope="col"><h6>total</h6></th>
                    <th class="text-uppercase text-xxs mb-0 text-center" scope="col"><h6>op. gravada</h6></th>
                    <th class="text-uppercase text-xxs mb-0 text-center" scope="col"><h6>igv</h6></th>
                    <th class="text-uppercase text-xxs mb-0 text-center" scope="col"><h6>total pagar</h6></th>
                    <th class="text-uppercase text-xxs mb-0 text-center" scope="col"><h6>importe pagado</h6></th>
            ...
            <tbody>
                ...
                @foreach ($ventas as $item)
                    <tr>
                        ...
                        <td class="text-xxs mb-0 text-center">{{$item->descuento}}</td>
                        <td class="text-xxs mb-0 text-center">{{$item->total}}</td>
                        <td class="text-xxs mb-0 text-center">{{$item->operacion_gravada}}</td>
                        <td class="text-xxs mb-0 text-center">{{$item->igv}}</td>
                        <td class="text-xxs mb-0 text-center">{{$item->total_pagar}}</td>
                        <td class="text-xxs mb-0 text-center">{{$item->importe_pagado}}</td>
                        <td class="text-xxs mb-0 text-center">{{$item->vuelto}}</td>
                        <td class="text-xxs mb-0 text-center">{{$item->created_at}}</td>
                        <td class="text-xxs mb-0 text-center">
                            ...
                            <a href="{{ route('boletaVenta', [$item->id]) }}" target="_blank" class="btn btn-primary"><i class="fas fa-file-pdf"></i> Boleta</a>
