...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="nd/assets/favicon.ico" />
        ...
        <link href="nd/css/styles.css" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><a class="nav-link" href="{{route('registro')}}">Registrate Ahora</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{route('inicio')}}">Iniciar Sesión</a></li>
                    </ul>
                </div>
            </div>
        </nav>
