...
@section('mainContent')
    <!--
        ...
        <body>
            <div>
                <div class="row">
                    <div style="width:50%;" cla4ss="col-6">
    ...
    <script>
        ...
        function getCantidadProductosPorCategoria() {
            $productos = DB::table('producto') - > groupBy('categoria') - > get();
            $resultados = [];
                    ...
                    <script>
                        ...
                        var datos = {
                            ...
                            datasets: [{
                                ...
                                backgroundColor: ['rgba(75, 192, 192, 0.5)', 'rgba(245, 59, 19, 0.5)',
                                    'rgba(100, 39, 19, 0.5)'
                                ],
