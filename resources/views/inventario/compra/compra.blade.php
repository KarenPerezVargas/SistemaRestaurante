        ...
        <div class="row gx-lg-5">
            <div class="navbar">
                <div class="container-fluid">
                    ...
                    <a href="{{route('createCompra')}}" class="btn btn-primary"><i class="fas fa-plus"></i>&nbsp;Nuevo Registro</a>
                </div>
            </div>
                                            ...
                                            <div class="modal-content">
                                                <form action="{{route('eliminarCompra', $item->id)}}" method="post">
                                                    ...
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Eliminacion de la compra</h5>
