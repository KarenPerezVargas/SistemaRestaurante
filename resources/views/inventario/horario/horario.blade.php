                    ...
                    <tbody>
                        ...
                        @foreach ($horario as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('editHorario', [$item->id])}}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i> Editar</a>
                                    &nbsp; &nbsp; &nbsp;
                                    ...
                                    <div class="modal fade" id="exampleModal-{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <form action="{{route('eliminarHorario', $item->id)}}" method="post">
                                                    @csrf
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <i>Se eliminara toda la información del horario del transporte</i>
                                                    </div>
