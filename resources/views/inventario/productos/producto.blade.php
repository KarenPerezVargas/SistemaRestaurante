        ...
        <div class="row gx-lg-5">
            <div class="navbar">
                <div class="container-fluid">
                    ...
                    <a href="{{route('createProducto')}}" class="btn btn-primary"><i class="fas fa-plus"></i>&nbsp;Nuevo Registro</a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($producto as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('editProducto', [$item->id])}}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i> Editar</a>
                                    &nbsp; &nbsp; &nbsp;
