        ...
        <div class="row gx-lg-5">
            <div class="navbar">
                <div class="container-fluid">
                    <h3><i>Blog para el Cliente</i></h3>
                    <a href="{{route('crearBlog')}}" class="btn btn-primary"><i class="fas fa-plus"></i>&nbsp;Nuevo Registro</a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($blog as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('editarBlog', [$item->id])}}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i> Editar</a>
                                    &nbsp; &nbsp; &nbsp;
                                    ...
                                    <div class="modal fade" id="exampleModal-{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <form action="{{route('eliminarBlog', $item->id)}}" method="post">
                                                    @csrf
