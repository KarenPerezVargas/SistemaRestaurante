...
@section('dashName', 'Registar Producto')

@section('mainContent')
    <div class="card mb-4">
        <div class="card-body">
            <form method="POST" action="{{route('producto.store')}}" class="row g-3">
                @csrf

                <label for=""><h6 style="color: rgb(52, 94, 52)">-------------- DATOS PRODUCTO --------------</h6></label>
